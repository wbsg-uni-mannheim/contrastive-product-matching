...
python run_finetune_siamese.py \
	--model_pretrained_checkpoint /your_path/contrastive-product-matching/reports/contrastive/amazongoogle-ssv-$PREAUG$BATCH-$LR-$TEMP-roberta-base/pytorch_model.bin \
    --do_train \
    ...
    --output_dir /your_path/contrastive-product-matching/reports/contrastive-ft-siamese/amazongoogle-ssv-$AUG$BATCH-$PREAUG$LR-$TEMP-unfrozen-roberta-base/ \
