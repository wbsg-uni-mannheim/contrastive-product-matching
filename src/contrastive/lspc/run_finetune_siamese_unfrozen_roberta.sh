...
python run_finetune_siamese.py \
	--model_pretrained_checkpoint /your_path/contrastive-product-matching/reports/contrastive/computers-$SIZE-$PREAUG$BATCH-$LR-$TEMP-roberta-base/pytorch_model.bin \
    --do_train \
	--frozen=False \
    ...
    --output_dir /your_path/contrastive-product-matching/reports/contrastive-ft-siamese/computers-$SIZE-$AUG$BATCH-$PREAUG$LR-$TEMP-unfrozen-roberta-base/ \
